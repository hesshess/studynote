...
const student = {
  ...
  // 숫자,boolean, null, undefinted는 따옴표 적용 안함
  studno: 10101,
  grade: 1,
  name: '학생1',
...
//접근하고자 하는 하위 변수의 이름을 동적으로 설정해야 할경우 type2가 활용된다.
...
for (const k of keys) {
  console.group(k);
  //추충된 key이름값(k)을 활용하여 실 데이터에 동적 접근 가능하다
